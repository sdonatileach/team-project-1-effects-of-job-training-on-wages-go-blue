...
inc <- read.csv("C:/Users/sdona/Documents/Duke/702IDS/Assignments/Team Projects/lalondedata.txt", header = TRUE) #colClasses=c("factor","factor","numeric","numeric","factor", "factor", "factor", "factor","numeric", "numeric", "numeric"))
